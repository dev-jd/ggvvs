                ...
                >
                  ...
                  {/* <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          this.props.navigation.navigate(
                            ...
                            {
                              itemData: this.state.doctor_details, member_id: this.state.member_id,
                              type: this.state.member_type
                            }
                          )
                        }
                    ...
                    <Switch
                      ...
                      value={this.state.doctorSwitch}
                      onValueChange={doctorSwitch =>
                        this.doctor_swich_apicall(doctorSwitch)
                      }
                      thumbColor={
                        this.state.doctorSwitch
                          ? Colors.Theme_color
                  ...
                  >
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          this.props.navigation.navigate('LookingForJob', {
                            itemData: this.state.job_seeker_details,
                            image_url: this.state.member_CV,
                            member_id: this.state.member_id,
                            type: this.state.member_type
                          })
                        }
                    ...
                    <Switch
                      ...
                      onValueChange={jobSwitch => this.jobseeker_swich_apicall(jobSwitch)}
                      thumbColor={
                        this.state.jobSwitch
                          ? Colors.Theme_color
                          : Colors.light_pink
                  ...
                  >
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          this.props.navigation.navigate('ViewJobProvider', {
                            itemData: this.state.job_provider_details,
                            member_id: this.state.member_id,
                            type: this.state.member_type
                          })
                        }
                    ...
                    <Switch
                      style={{ position: 'absolute', right: 0 }}
                      value={this.state.providerSwitch}
                      onValueChange={providerSwitch =>
                        this.jobProvider_swich_apicall(providerSwitch)
                      }
                      thumbColor={
                        this.state.providerSwitch
                          ? Colors.Theme_color
