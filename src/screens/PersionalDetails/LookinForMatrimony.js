...
export default class LookinForMatrimony extends Component {
  ...
  async apiCalling() {
    ...
    this.setState({
      ...
      img_url_profile: response.member_photo,
    })
  ...
  async editData() {
    var { name, kundliBelive, matrimonyId, birthPlace, idSelect, birthTime, kundliImage, img_url, skinColor, btime, profiletagline, isManglik, gotra, casttatus, personaldesc, heightfFeet, heightInch, weight, showTimepicker,
  ...
  render() {
    var { isActive, name, kundliBelive, birthPlace, idSelect, birthTime, kundliImage, img_url, img_url_profile, skinColor, btime, profiletagline, isManglik, gotra, casttatus, personaldesc, heightfFeet, heightInch, weight, showTimepicker,
      education, educationdesc, lifestylechoice, expectation, fathername, fatherProfession, mothername, motherprofession, otherfamilydetails, nativeplace, familydesc, profession, professiondesc, income,
    ...
    // } else {
      return (
        <SafeAreaView style={{ flex: 1 }}>
          ...
          <ImageBackground source={AppImages.back2} style={{
            flex: 1,
            resizeMode: "cover",
              ...
              <ScrollView>
                <View style={{ padding: '3%' }}>
                  ...
                  <Collapse>
                    ...
                    <CollapseBody style={[Style.cardback,{backgroundColor:  Colors.lightwhite ,}]}>
