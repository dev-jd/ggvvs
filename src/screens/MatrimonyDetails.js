          ...
          <ScrollView style={{ paddingVertical: '5%', paddingHorizontal: '2%' }}>
            <View>
              ...
              <Collapse>
                ...
                <CollapseBody style={[Style.cardback]}>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    ...
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '30%' }]}>{Moment(item_details.member_birth_date).format('DD-MM-YYYY')}</Label>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '30%' }]}>Birth-Time</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '20%' }]}>{matrimonyData.mm_birth_time}</Label>
                  </View>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>Birth Place</Label>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>{matrimonyData.mm_birth_place}</Label>
                  </View>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '20%' }]}>Height</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '30%' }]}>{validationempty(matrimonyData.mm_height) ? matrimonyData.mm_height : '' + "'" + validationempty(matrimonyData.mm_height_inch) ? matrimonyData.mm_height_inch : ''}</Label>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '30%' }]}>Weight</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '20%' }]}>{matrimonyData.mm_weight}</Label>
                  </View>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>Skin Color</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>{validationempty(matrimonyData.mm_color) ? matrimonyData.mm_color : ''}</Label>
                  </View>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '30%' }]}>Manglik</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '20%' }]}>{matrimonyData.mm_manglik == 1 ? 'Yes' : 'No'}</Label>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '40%' }]}>Belive in Kundli</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '10%' }]}>{matrimonyData.dont_believe_in_kundali == 1 ? 'No' : 'Yes'}</Label>
                  </View>
                  <View style={{ paddingVertical: '2%' }}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>Personal description</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>{validationempty(matrimonyData.person_description) ? matrimonyData.person_description : '-'}</Label>
                  </View>
                  <View>
              ...
              <Collapse>
                ...
                <CollapseBody style={[Style.cardback]}>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    ...
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '40%' }]}>{validationempty(matrimonyData.mm_education) ? matrimonyData.mm_education : '-'}</Label>
                  </View>
                  <View style={{ paddingVertical: '2%' }}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>Description</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>{validationempty(matrimonyData.mm_education_description) ? matrimonyData.mm_education_description : '-'}</Label>
                  </View>
                </CollapseBody>
              </Collapse>
              <Collapse>
                ...
                <CollapseBody style={[Style.cardback]}>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    ...
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>{validationempty(item_details.member_father) ? item_details.member_father : '-'}</Label>
                  </View>
                  <View style={{ paddingVertical: '2%' }}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>Father's Profession</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>{validationempty(matrimonyData.father_profession) ? matrimonyData.father_profession : '-'}</Label>
                  </View>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>Mother Name</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>{validationempty(item_details.member_mother) ? item_details.member_mother : '-'}</Label>
                  </View>
                  <View style={{ paddingVertical: '2%' }}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>Mother's Profession</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>{validationempty(matrimonyData.mother_profession) ? matrimonyData.mother_profession : '-'}</Label>
                  </View>
                  <View style={{ paddingVertical: '2%' }}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>Other Family Details</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>{validationempty(matrimonyData.family_other_details) ? matrimonyData.family_other_details : '-'}</Label>
                  </View>

                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>Native Place</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>{validationempty(item_details.member_native_place) ? item_details.member_native_place : '-'}</Label>
                  </View>
                  <View style={{ paddingVertical: '2%' }}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>Description</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>{validationempty(matrimonyData.family_details) ? matrimonyData.family_details : '-'}</Label>
                  </View>
                </CollapseBody>
              </Collapse>
              <Collapse>
                ...
                <CollapseBody style={[Style.cardback]}>
                  <View style={{ paddingVertical: '2%' }}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>Description</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>{validationempty(matrimonyData.lifestyle_choice) ? matrimonyData.lifestyle_choice : '-'}</Label>
                  </View>
                  <View style={{ paddingVertical: '2%' }}>
                    ...
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>{validationempty(matrimonyData.mm_expectations) ? matrimonyData.mm_expectations : '-'}</Label>
                  </View>
                </CollapseBody>
              </Collapse>
              <Collapse>
                ...
                <CollapseBody style={[Style.cardback]}>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    ...
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>{validationempty(matrimonyData.profession) ? matrimonyData.profession : '-'}</Label>
                  </View>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>Yearly Income</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '50%' }]}>{validationempty(matrimonyData.mm_income) ? matrimonyData.mm_income : '-'}</Label>
                  </View>
                  <View style={{ paddingVertical: '2%' }}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>Description</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>{validationempty(matrimonyData.profession_details) ? matrimonyData.profession_details : '-'}</Label>
                  </View>
              ...
              <Collapse>
                ...
                <CollapseBody style={[Style.cardback]}>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    ...
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '20%' }]}>{validationempty(matrimonyData.pustimarg) ? (matrimonyData.pustimarg == 2 ? "No" : "Yes") : '-'}</Label>
                  </View>
                  <View style={{ paddingVertical: '2%' }}>
                    ...
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>{validationempty(matrimonyData.sp_path) ? matrimonyData.sp_path : '-'}</Label>
                  </View>
                  <View style={{ paddingVertical: '2%' }}>
                    ...
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>{validationempty(matrimonyData.positive_point) ? matrimonyData.positive_point : '-'}</Label>
                  </View>
                  <View style={{ paddingVertical: '2%' }}>
                    ...
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>{validationempty(matrimonyData.negative_point) ? matrimonyData.negative_point : '-'}</Label>
                  </View>
                </CollapseBody>
              </Collapse>
              <Collapse>
                ...
                <CollapseBody style={[Style.cardback]}>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    ...
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '60%' }]}>{validationempty(item_details.member_mobile) ? item_details.member_mobile : '-'}</Label>
                  </View>
                  {/* <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                  ...
                  <View style={{ paddingVertical: '2%' }}>
                    ...
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '100%' }]}>{validationempty(item_details.member_email) ? item_details.member_email : '-'}</Label>
                  </View>
                  <View style={{ paddingVertical: '2%' }}>
              ...
              <Collapse>
                ...
                <CollapseBody style={[Style.cardback]}>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '80%' }]}>Looking For NRI?</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '20%' }]}>{validationempty(matrimonyData.looking_for_nri) ? (matrimonyData.looking_for_nri == 2 ? "No" : "Yes") : '-'}</Label>
                  </View>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '80%' }]}>Do you take alcohol or hard drink?</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '20%' }]}>{validationempty(matrimonyData.mm_drink) ? (matrimonyData.mm_drink == 2 ? "No" : "Yes") : '-'}</Label>
                  </View>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '80%' }]}>Do you smoke?</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '20%' }]}>{validationempty(matrimonyData.mm_smoke) ? (matrimonyData.mm_smoke == 2 ? "No" : "Yes") : '-'}</Label>
                  </View>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '80%' }]}>Do you eat non-veg?</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '20%' }]}>{validationempty(matrimonyData.mm_nonveg) ? (matrimonyData.mm_nonveg == 2 ? "No" : "Yes") : '-'}</Label>
                  </View>
                  <View style={[Style.flexView, { paddingVertical: '2%' }]}>
                    <Label style={[Style.Textmainstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '80%' }]}>Do you eat Egg ?</Label>
                    <Label style={[Style.Textstyle, { color: Colors.black, fontFamily: CustomeFonts.medium, width: '20%' }]}>{validationempty(matrimonyData.mm_egg) ? (matrimonyData.mm_egg == 2 ? "No" : "Yes") : '-'}</Label>
                  </View>
                </CollapseBody>
              </Collapse>
              <Collapse>
